...
async function main() {
  ...
  try {
    ...
    await prisma.$executeRawUnsafe(`
      INSERT INTO "CalendarNote" ("id", "userId", "startDate", "title", "category", "externalId", "source", "updatedAt", "isWeeklyNote")
      VALUES ('test-uuid-123', '${userId}', NOW(), 'SQL Test', 'NOTE', 'SQL_TEST', 'intervals', NOW(), false)
    `)
