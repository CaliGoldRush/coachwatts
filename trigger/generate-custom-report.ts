...
function buildCustomPrompt(config: any, workouts: any[], nutrition: any[], metrics: any[], user: any): string {
  ...
  const focusAreaPrompts: Record<string, string> = {
    performance: "Focus heavily on performance trends, power metrics, pace improvements, and competitive readiness.",
    recovery: "Emphasize recovery patterns, fatigue management, training stress balance, and readiness optimization.",
    consistency: "Analyze training adherence, consistency patterns, missed sessions, and strategies to maintain regular training.",
    nutrition: "Deep dive into dietary patterns, macronutrient balance, calorie adequacy, meal timing, and nutrition quality.",
