              ...
              >
                ...
                >
                  ...
                  <div class="text-[10px] opacity-80 mt-1">
                    ...
                    <span v-else>
                      {{ getInferredIntensity(step) * 100 }}% (Inferred)
                    </span>
                  </div>
                </div>
              </div>
      ...
      <div class="space-y-2">
        ...
        <div class="space-y-1">
          <div
            v-for="(step, index) in workout.steps"
            :key="index"
            class="grid grid-cols-[12px_1fr_48px_80px_110px] items-start gap-4 p-2 rounded hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors"
          >
            <div class="w-3 h-3 rounded-full flex-shrink-0 mt-1" :style="{ backgroundColor: getStepColor(getStepIntensity(step)) }"/>
            <div class="min-w-0">
            ...
            <div class="text-right">
              <div class="text-sm font-bold whitespace-nowrap">
                ...
                <span v-else>
                  {{ getInferredIntensity(step) * 100 }}% (Est)
                </span>
              </div>
