        ...
        <div>
          ...
          <div class="mt-4">
            <svg viewBox="0 0 200 200" class="w-full max-w-[200px] mx-auto">
              <circle cx="100" cy="100" r="90" fill="none" stroke="currentColor" stroke-width="1" class="text-gray-200 dark:text-gray-700" />
        ...
        <div>
          ...
          <div class="relative h-32">
            <svg viewBox="0 0 300 100" class="w-full h-full" preserveAspectRatio="none">
              <!-- Grid lines -->
              <line x1="0" y1="25" x2="300" y2="25" stroke="currentColor" stroke-width="0.5" class="text-gray-200 dark:text-gray-700" />
              <line x1="0" y1="50" x2="300" y2="50" stroke="currentColor" stroke-width="0.5" class="text-gray-200 dark:text-gray-700" />
              <line x1="0" y1="75" x2="300" y2="75" stroke="currentColor" stroke-width="0.5" class="text-gray-200 dark:text-gray-700" />
