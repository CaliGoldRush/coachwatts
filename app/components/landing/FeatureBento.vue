<template>
  <div id="features" class="bg-gray-50 dark:bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <h2 class="text-base font-semibold leading-7 text-primary-600 dark:text-primary-400 font-mono">UNFAIR ADVANTAGE
      </h2>
      <p class="mt-2 max-w-lg text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
      ...
      <div class="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
        ...
        <div class="relative lg:col-span-3 lg:row-span-2 group">
          ...
          <div
            ...
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 dark:text-white max-lg:text-center">Plans
                That Adapt When Life Happens</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400 max-lg:text-center">
                Plans that adapt to your sleep score. If you slept 4 hours, we won't ask for a VO2 Max session.
              </p>
            </div>
            <div class="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
              <div
                class="absolute inset-x-10 bottom-0 top-10 overflow-hidden rounded-t-xl bg-gray-900 shadow-2xl transition-transform duration-500 group-hover:-translate-y-2">
                <!-- Mock UI: Daily Plan -->
        ...
        <div class="relative lg:col-span-3 group">
          ...
          <div
            ...
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 dark:text-white max-lg:text-center">The
                Perfect Pacing Strategy</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400 max-lg:text-center">
...
name="i-heroicons-map-pin"
        ...
        <div class="relative lg:col-span-2 group">
          ...
          <div
            ...
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 dark:text-white max-lg:text-center">Fuel
                Like a Ferrari</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400 max-lg:text-center">
...
name="i-heroicons-cake"
        ...
        <div class="relative lg:col-span-1 group">
          ...
          <div
            ...
            <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p class="mt-2 text-lg font-medium tracking-tight text-gray-950 dark:text-white max-lg:text-center">24/7
                Coaching Brain</p>
              <p class="mt-2 max-w-lg text-sm/6 text-gray-600 dark:text-gray-400 max-lg:text-center">
                Ask anything.
              </p>
