            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-sm text-muted">
                  Enter your Hevy API key to connect your account.
                </p>
              </div>
            </div>
          </template>
          ...
          <div class="space-y-6">
            <div class="bg-muted/50 p-4 rounded-lg">
              ...
              <ol class="text-sm text-muted space-y-2">
                <li>1. Go to <a href="https://hevy.com/settings?developer" target="_blank" class="text-primary hover:underline">hevy.com/settings</a> (Developer section)</li>
...
useHead({
  title: 'Connect Hevy',
  meta: [
    { name: 'description', content: 'Connect your Hevy account to import strength training workouts.' }
  ]
})
