        ...
        <UCard>
          <template #header>
            <div class="flex items-center gap-4">
              <div class="w-12 h-12 bg-white rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-700">
                <img src="/images/logos/withings.png" alt="Withings" class="w-8 h-8 object-contain" />
              </div>
              <div>
