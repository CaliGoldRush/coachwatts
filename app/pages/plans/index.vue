      ...
      <div class="p-6 space-y-8">
        ...
        <div>
          <div class="flex items-center justify-between mb-4">
            ...
            <div v-if="history.length > 3 && !showAllHistory" class="text-sm text-gray-500 dark:text-gray-400">
    ...
    <template #body>
      ...
      <div v-else-if="selectedPlanDetail" class="space-y-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
          ...
          <p v-if="selectedPlanDetail.description" class="mt-3 text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap">
